...
export default function BackToBackImageSlider(props: IProps) {
  const {
    aspectRatio = "taller",
    handle = null,
    handleSize = 40,
  ...
  useEffect(() => {
    ...
    const startSliding = (e: { preventDefault: () => void }) => {
      setIsSliding(true);
  ...
  const styles: { [key: string]: React.CSSProperties } = {
    ...
    rightLabel: {
      ...
      right: horizontal ? "5%" : 0,
      top: horizontal ? "50%" : 0,
      bottom: horizontal ? 0 : "3%",
      transform: horizontal ? "translate(0,-50%)" : "translate(-50%, 0)",
      transition: "opacity 0.1s ease-out",
    },
    leftLabelContainer: {
...
// addPropertyControls(BackToBackImageSlider, {
//   leftImage: {
//     type: ControlType.Image,
//     defaultValue:
//       "https://uploads.codesandbox.io/uploads/user/99e3605e-982c-4a1f-8e02-1bcf37f8dd15/oVtF-2.png",
//   },
//   rightImage: {
//     type: ControlType.Image,
//     defaultValue:
//       "https://uploads.codesandbox.io/uploads/user/99e3605e-982c-4a1f-8e02-1bcf37f8dd15/1iOR-1.png",
//   },
//   vertical: {
